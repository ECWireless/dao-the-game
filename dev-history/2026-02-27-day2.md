...
- Reframed onboarding as an app-within-phone narrative flow (`Messages`, `Mail`, `Whiteboard`, `RaidGuild`, `Factory`) with scripted forward momentum.
...
- Added execution lock during factory run so cinematic sequences cannot be interrupted.
...
- Added staggered motion for chat bubbles, notification entries, guild candidate responses, and factory phase lamps.
- Added factory pipeline sequencing with phase progression and deferred score reveal behavior.
